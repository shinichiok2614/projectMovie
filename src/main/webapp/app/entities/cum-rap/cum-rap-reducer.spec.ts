...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cum-rap.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUMRAP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUMRAP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUMRAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUMRAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUMRAP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUMRAP actions', async () => {
      const arg = 42666;
