...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ghe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GHE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GHE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GHE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GHE actions', async () => {
      const arg = 42666;
