...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './phim.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHIM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PHIM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PHIM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PHIM actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PHIM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PHIM actions', async () => {
      const arg = 42666;
