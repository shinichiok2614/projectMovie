...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './phong.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PHONG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PHONG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PHONG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PHONG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PHONG actions', async () => {
      const arg = 42666;
