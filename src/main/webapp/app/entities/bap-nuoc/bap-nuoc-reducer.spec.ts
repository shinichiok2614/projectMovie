...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bap-nuoc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BAPNUOC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BAPNUOC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BAPNUOC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BAPNUOC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BAPNUOC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BAPNUOC actions', async () => {
      const arg = 42666;
