...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './loai-ghe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOAIGHE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOAIGHE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOAIGHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOAIGHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOAIGHE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOAIGHE actions', async () => {
      const arg = 42666;
