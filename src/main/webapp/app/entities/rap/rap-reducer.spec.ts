...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rap.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAP_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RAP actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RAP actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RAP actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RAP actions', async () => {
      const arg = 42666;
