...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './danh-sach-bap-nuoc.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DANHSACHBAPNUOC_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DANHSACHBAPNUOC actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DANHSACHBAPNUOC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DANHSACHBAPNUOC actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DANHSACHBAPNUOC actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DANHSACHBAPNUOC actions', async () => {
      const arg = 42666;
