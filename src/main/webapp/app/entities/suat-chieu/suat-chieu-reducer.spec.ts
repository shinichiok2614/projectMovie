...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUATCHIEU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SUATCHIEU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SUATCHIEU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SUATCHIEU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SUATCHIEU actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SUATCHIEU actions', async () => {
      const arg = 42666;
