...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ve.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VE actions', async () => {
      const arg = 42666;
