...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DANHSACHGHE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DANHSACHGHE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DANHSACHGHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DANHSACHGHE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DANHSACHGHE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DANHSACHGHE actions', async () => {
      const arg = 42666;
